...
def writeFeatureVector():
    ...
    f = open('../NLP_final/fv_uni_svm_test_pos_only','w')
    ...
    for infile in listing:
        if infile != '.DS_Store':
            ...
            #f.write(str(count)+":"+str(word_per_line_alter[count_alter]))
            #count_alter += 1
  ...
  '''  #folk
    ...
    for infile in listing:
        if infile != '.DS_Store':
            ...
            #f.write(str(count)+":"+str(word_per_line_folk[count_folk]))
            #count_folk += 1
            f.write("\n")
    ...
    for infile in listing:
        if infile != '.DS_Store':
            ...
            #f.write(str(count)+":"+str(word_per_line_metal[count_metal]))
            #count_metal += 1
            f.write("\n")
   ...
   #country
    ...
    for infile in listing:
        if infile != '.DS_Store':
            ...
            #f.write(str(count)+":"+str(word_per_line_country[count_country]))
            #count_country += 1
            f.write("\n")
    ...
    for infile in listing:
        if infile != '.DS_Store':
            ...
            #f.write(str(count)+":"+str(word_per_line_electronic[count_electronic]))
            #count_electronic += 1
            f.write("\n")
   ...
   #jazz
    ...
    for infile in listing:
        if infile != '.DS_Store':
            ...
            #f.write(str(count)+":"+str(word_per_line_jazz[count_jazz]))
            #count_jazz += 1
            f.write("\n")'''



def createWordCountTest():
    #read all files from a directory (training data)
    path = "../NLP_final/NLP/corpus"
