...
def createCorpus():
    ...
    path = "../NLP_final/NLP_year/corpus"
...
def writeFeatureVector():
    ...
    path = "../NLP_final/NLP_year/1D_Test"
    path_m = "../NLP_final/NLP_year/2D_Test"
    path_f =  "../NLP_final/NLP_year/3D_Test"

    f = open('../NLP_final/fv_uni_svm_year_test','w')
